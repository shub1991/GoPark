...
<body>
    ...
    <div class="container">
     <form class="col-sm-10 bg-info" action="includes/addBooking.php " method="POST">
        ...
        <div class="form-group row">
            <label  class="col-sm-2 col-form-label">Price/Hour</label>
            <label  class="col-sm-10 col-form-label">$10</label> 
        </div>
        <div class="form-group row">
